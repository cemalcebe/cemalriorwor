...
app.listen(8000);
setInterval(() => {
  http.get("https://cemalcebe-olive-1.glitch.me/");
}, 280000);
//-----------------------------------------------\\
...
client.on("voiceStateUpdate", (oldMember, newMember) => {
  if (
    ...
    if (
      ...
      newMember.setVoiceChannel("717833035168481372");
    }
  }
});
  ...
  if (old.username !== nev.username) {
    if (
      ...
      const embed1 = new Discord.RichEmbed()
        .setColor()
        .setDescription(
          `${nev} tagımızı çıkardığı için aramıza ayrıldı ve **Riorwor Bot** tarafından **Reputable** rolü alındı!`
        );
      client.channels.get("711241863876837442").send(embed1);
      client.guilds
        .get("711241862781992961")
        .members.get(nev.id)
        .removeRole("711241863125794821");
    }
    if (
      nev.username.includes("ʀ") &&
      !client.guilds
      ...
      const embed2 = new Discord.RichEmbed()
        .setColor()
        .setDescription(
          `${nev} tagımızı aldığı için aramıza katıldı ve **Riorwor Bot** tarafından **Reputable** rolü verildi!`
        );
        client.channels.get("711241863876837442").send(embed2);
      client.guilds
        .get("711241862781992961")
        .members.get(nev.id)
